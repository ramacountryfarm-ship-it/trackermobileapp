plugins {
    ...
    id("kotlin-android")
    // id("com.google.gms.google-services")  // Re-enable after adding google-services.json
    // The Flutter Gradle Plugin must be applied after the Android and Kotlin Gradle plugins.
    id("dev.flutter.flutter-gradle-plugin")
}

android {
    namespace = "com.rcftracker.rcf_tracker"
    ...
    defaultConfig {
        ...
        applicationId = "com.rcftracker.rcf_tracker"
